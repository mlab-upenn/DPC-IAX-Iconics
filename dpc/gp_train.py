...
XdTrain, XcTrain, yTrain = load_data('train', buildingType, features_d, features_c, output)
XdTest, XcTest, yTest = load_data('test', buildingType, features_d, features_c, output)
...
XdTest = XdTest.iloc[0:n_test_samples,:]
XcTest = XcTest.iloc[0:n_test_samples,:]
yTest = yTest.iloc[0:n_test_samples,:]
...
ymu = normalizer_y.inverse_transform(ymu)
...
if save_results:
    ...
    filename = ('models/gp-%s-numsamples-%s.pickle' %(buildingType, n_samples))
